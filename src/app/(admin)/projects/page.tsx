...
// This ensures the page always fetches the latest data
            ...
            <TableBody>
                {projects.map((project) => (
                    <TableRow key={project.id}>
                        ...
                        <TableCell>{project.leadInvestigator.name}</TableCell>
                        <TableCell className="text-right">
                            <div className="flex items-center justify-end gap-1.5">
                                <Star className="h-4 w-4 text-amber-400" />
                                <span className="font-bold">{project.aiScore?.toFixed(1) ?? '-'}</span>
                            </div>
                        </TableCell>
                        <TableCell>
                            <DropdownMenu>
